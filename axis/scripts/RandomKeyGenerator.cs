...
public partial class RandomKeyGenerator : KeyGenerator
{
	...
	private void UpdatePlayerData()
	{
		...
		{
			int highScore = PlayerData.EndlessScores[GameData.KeySpeed];
			if (highScore < PlayerData.TotalScore) PlayerData.EndlessScores[GameData.KeySpeed] = PlayerData.TotalScore;
		}
		else
		{
