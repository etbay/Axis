...
public partial class PlayerController : Node2D
{
	...
	{
		if (Input.IsActionJustPressed("move_pad_up") && !leftPad.IsKeyBeingHeld && !rightPad.IsKeyBeingHeld)
		{
		...
		else if (Input.IsActionJustPressed("move_pad_down") && !leftPad.IsKeyBeingHeld && !rightPad.IsKeyBeingHeld)
		{
		...
		if (Input.IsActionJustPressed("move_pad_left") && !upPad.IsKeyBeingHeld && !downPad.IsKeyBeingHeld)
		{
		...
		else if (Input.IsActionJustPressed("move_pad_right") && !upPad.IsKeyBeingHeld && !downPad.IsKeyBeingHeld)
		{
